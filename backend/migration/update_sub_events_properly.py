...
for file_path in ui_files:
    ...
    # The block we want to append after is the textarea block. We can just find `required={form.is_festival}\n                          />` or similar.
    # Let's find the exact string that closes the textarea.
    # In FacultyDashboard: `required={form.is_festival}\n                          />`
    # In HOD/ExecDashboard: `required={formData.is_festival}\n                                  />`
    ...
    if "Solo" not in content and "Group" not in content:
        # Let's find the closing tag of the textarea
