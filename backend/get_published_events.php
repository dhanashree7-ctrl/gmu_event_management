...
while ($row = $result->fetch_assoc()) {
    ...
    $events[] = [
        ...
        'details'               => $attachments['details'] ?? null,
        'participation_type'    => $attachments['details']['participation_type'] ?? 'solo',
        ...
        'max_volunteers'        => $attachments['details']['max_volunteers'] ?? null,
        'max_coordinators'      => $attachments['details']['max_coordinators'] ?? null,
