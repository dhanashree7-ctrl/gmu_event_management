...
$ins_stmt = $conn->prepare("
    INSERT INTO users (USER_NAME, ID, NAME, PASSWORD, USER_GROUP, DISCIPLINE) 
    VALUES (?, ?, ?, ?, ?, ?)
");
$ins_stmt->bind_param('ssssss', $usn_or_emp_id, $usn_or_emp_id, $full_name, $hashed_password, $system_role, $department);
