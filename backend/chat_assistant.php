...
$sql = "SELECT EVENT AS event_title, START_DATE AS event_date, START_TIME AS event_time, VENUE AS venue, CATEGORY AS category, TYPE AS event_scale FROM event_master WHERE CURRENT_STATUS IN ('published', 'approved') ORDER BY START_DATE ASC";
