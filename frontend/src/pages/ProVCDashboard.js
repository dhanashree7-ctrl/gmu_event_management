...
export default function ProVCDashboard() {
  ...
  useEffect(() => {
    const fetchPending = async () => {
      setLoading(true);
      try {
        const res = await fetch(`${API_BASE}/get_pending_events.php?status=pending_provc`);
    ...
    <div style={styles.root}>
      ...
      <aside style={styles.sidebar}>
        ...
        <div style={styles.sidebarUserCard}>
          <div style={styles.userInfo}>
            <p style={styles.userName}>{user?.name ?? 'ProVC'}</p>
      ...
      <div style={styles.main}>
        <header style={styles.topBar}>
          <h1 style={styles.topBarTitle}>ProVC Approval Dashboard</h1>
        </header>
                ...
                <div key={evt.id} style={styles.eventCard}>
                  ...
                  <div style={styles.cardActions}>
                    <button
                      ...
                      onClick={() => handleAction(evt.id, 'pending_vc')}
