  ...
  return (
    <div style={styles.root}>
      ...
      <header className="pre-login-header" style={s(styles.header, scrolled && styles.headerScrolled)}>
        <div className="header-inner" style={styles.headerInner}>
          ...
          <div className="pre-login-logo" style={styles.logo} onClick={() => scrollTo('hero')} role="button" tabIndex={0}>
            <div className="crest" style={styles.crest}>⚜</div>
      ...
      <section id="hero" ref={heroRef} style={styles.hero}>
        {/* Decorative background shapes removed as per request */}
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroHeadline}>
            Orchestrate Every Event <br />
            <span style={styles.heroHeadlineAccent}>with Precision & Pride</span>
          </h1>
        ...
        {/* Scroll indicator */}
        <div style={styles.scrollIndicator} onClick={() => scrollTo('features')} role="button" tabIndex={0} aria-label="Scroll to features">
      ...
      <section id="gallery" style={styles.gallerySection}>
        <div style={styles.sectionContainer}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.5rem', color: theme.colors.maroon, fontWeight: 'bold', fontFamily: theme.fonts.serif, marginBottom: '0.5rem' }}>
              The Creative Lens
            </h2>
            <div style={{ width: '80px', height: '4px', backgroundColor: theme.colors.gold, margin: '0 auto 1rem' }} />
            <p style={{ fontSize: '1.1rem', color: '#666' }}>Every Frame Tells a Story of Innovation</p>
          </div>
      ...
      <section id="features" style={styles.featuresSection}>
        <div style={styles.sectionContainer}>
          <div style={styles.sectionHeader}>
            ...
            <h2 style={styles.sectionTitle}>Everything You Need to Run a Great Event</h2>
            <p style={styles.sectionSubtitle}>
              Six powerful modules built around the real workflow of university event teams.
            </p>
          </div>
        ...
        <div style={styles.aboutContainer}>
          ...
          <div style={styles.aboutVisual}>
            <div style={styles.workflowCard}>
              ...
              {[
                { step: '01', label: 'Proposal Submitted',  color: theme.colors.maroon },
                { step: '02', label: 'Faculty Approval',    color: '#7B1E1E' },
                { step: '03', label: 'Admin Sign-off',      color: '#9B3333' },
                { step: '04', label: 'Brochure Generated',  color: theme.colors.gold },
                { step: '05', label: 'QR Check-In Live',    color: theme.colors.goldDark },
                { step: '06', label: 'Report Archived',     color: '#2E7D32' },
              ].map(({ step, label, color }, i) => (
                <div key={step} style={styles.workflowStep}>
                  <div style={s(styles.stepBadge, { backgroundColor: color })}>
                    {step}
                  </div>
                  <span style={styles.stepLabel}>{label}</span>
                  {i < 5 && <div style={styles.stepConnector} />}
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="login-section" style={styles.loginSection}>
        <div style={styles.loginCard}>
          <div style={styles.loginCardIcon}>🔐</div>
        ...
        <div style={styles.footerInner}>
          <div style={styles.footerBrand}>
            ...
            <p style={styles.footerTagline}>
              Empowering campus life through intelligent event management.
            </p>
          </div>
...
const styles = {
  ...
  hero: {
    ...
    background:     `linear-gradient(135deg, rgba(82, 0, 0, 0.95) 0%, rgba(30, 0, 0, 0.9) 100%), url('https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&q=80&w=2000')`,
  ...
  heroBgCircle1: {
    ...
    height:        '600px',
    borderRadius:  '50%',
    background:    'radial-gradient(circle, rgba(253,208,111,0.03) 0%, transparent 60%)',
    top:           '-150px',
    right:         '-100px',
    pointerEvents: 'none',
  },
  heroBgCircle2: {
    ...
    height:        '400px',
    borderRadius:  '50%',
    background:    'radial-gradient(circle, rgba(253,208,111,0.02) 0%, transparent 60%)',
    bottom:        '100px',
    left:          '-80px',
    pointerEvents: 'none',
  },
  heroBgCircle3: {
    ...
    height:        '200px',
    borderRadius:  '50%',
    border:        '1px solid rgba(253,208,111,0.12)',
    top:           '30%',
    left:          '15%',
    pointerEvents: 'none',
