...
const styles = {
  ...
  metricCard: { background: '#fff', borderRadius: '12px', padding: '1.5rem', textAlign: 'center', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', borderBottom: `4px solid ${theme.colors.gold}` },
  metricValue: { fontSize: '2.5rem', fontWeight: 'bold', color: theme.colors.maroon, lineHeight: 1 },
  metricLabel: { marginTop: '0.5rem', fontSize: '0.9rem', color: '#666', fontWeight: 500 },
